...
const Information = () => {
  return (
    ...
    <NavigateBackButton />
      ...
      <h2>Tips for not getting bitten by a tick</h2>
      <ol>
        <li>
          Wear a long-sleeved shirt, long trousers, and high shoes or boots
          whenever you are out in nature.
        </li>
        <li>Check your body for ticks after you have been out in nature.</li>
        <li>Check your skin when you get undressed or shower/take a bath.</li>
        <li>Check your children's skin after they have been out in nature.</li>
        <li>Check your dogs, cats or any other animals in the household</li>
      </ol>

      <h2>Vaccination against TBE</h2>
      <p>
      ...
      <ol>
        <li>Uppland</li>
        <li>Stockholm County, near the sea</li>
        <li>Södermanland</li>
        <li>Västra Götaland County</li>
      </ol>
      <p>
